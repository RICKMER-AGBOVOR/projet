...
app=Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI']='postgresql://postgres:{}@{}:5432/bookshop'.format(password,host)
...
class Livre(db.Model):
    ...
    idcat=db.Column(db.Integer, db.ForeignKey("categories.id"),nullable=False)
